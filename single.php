<?php while (have_posts()) : the_post(); ?>
    ...
    <?php 
        ...
        $imageurl = pn_get_image_url($post_thumbnail_id, "large");
        ...
        <div class="container">
            <div class="row">
                <div class="article">
                    ...
                    <div class="ms-list">
                        <ul>
                            <li class="ms-text back"><a href="<?php echo pn_get_url_from_template("pages/page-blog.php"); ?>">< <?php _e("Back", "tracktik"); ?></a></li>
                    ...
                    <?php if($cta_title) { ?>
                        ...
                        <a href="<?php echo $cta_link; ?>" class="btn <?php echo  $cta_nomClasse ;?>" data-tracking="<?php //echo $datatracking; ?>" 
