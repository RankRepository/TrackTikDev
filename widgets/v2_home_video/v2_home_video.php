...
/*
Widget Name: Tracktik V2 - Background Video
...
if (!class_exists('V2_HomeVideo_Tracktik_Widget')) {

class V2_HomeVideo_Tracktik_Widget extends SiteOrigin_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'v2_home_video-tracktik-widget',                                       // The unique id for your widget.
            'V2 Block with Background Video',        // The name of the widget for display purposes.
...
siteorigin_widget_register('v2_home_video-tracktik-widget', __FILE__, 'V2_HomeVideo_Tracktik_Widget');